...
gl.shaderSource(vertexShader, getSourceSynch('vertexShader3.glsl'))
gl.shaderSource(fragmentShader, getSourceSynch('fragmentShader3.glsl'))
...
var repaint = function () {
    ...
    if(!hit || (Math.floor((window.performance.now()-hittime)/hitchangeduration))%2==1) {
        ...
        gl.uniform3fv(colorUniformLocation, new Float32Array([0.0, 1.0, 1.0]))
        gl.uniform2fv(rotateUniformLocation, new Float32Array([1.0, 0.0]))
    ...
    gl.uniform3fv(colorUniformLocation, new Float32Array([0.5, 0.25, 1.0]))
    gl.uniform2fv(rotateUniformLocation, new Float32Array([1.0, 0.0]))
